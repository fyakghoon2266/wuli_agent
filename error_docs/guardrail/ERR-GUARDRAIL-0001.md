...
如果你遇到 Content has been rejected by rejected check during th input/output process，通常代表：
- 內容觸犯了正則表達式的邏輯
- 有小概率工程師正在重新部署正則表達式的規則

建議：
1. 可以使用以下工具來測試看看是觸犯了哪一個正則表達式的政策[護欄內容檢查系統](https://35.78.254.119/guardrails)
